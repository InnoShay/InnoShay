...
export function Navigation() {
  ...
  return (
    <>
      ...
      >
        <motion.nav
          className="pointer-events-auto relative overflow-hidden rounded-[40px] border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.4)] transition-colors duration-300 flex items-center justify-between"
          style={{
            width: capsuleWidth,
            ...
            backgroundColor: `rgba(7,8,10,${capsuleBgOpacity.get()})`, // Updates via framer motion
            backdropFilter: `blur(${capsuleBlur.get()})`,
            // Fallback string for initial render
          }}
          // We use onUpdate or dynamic strings to handle complex filter updates smoothly
          animate={{
