  ...
  return (
    <section className="w-full py-[120px] md:py-[200px] bg-bg-base relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 flex flex-col items-center">
        ...
        {/* Section Headings — OUTSIDE the macOS frame, on dark bg */}
        ...
        {/* macOS Desktop Frame */}
        <div
          className="relative w-full max-w-[1100px] h-[700px] md:h-[750px] rounded-2xl overflow-hidden border border-white/15 flex flex-col"
          style={{
            backgroundImage: "url('/macos-wallpaper.png')",
            backgroundSize: "cover",
            backgroundPosition: "center",
            boxShadow: "0 40px 80px -10px rgba(0,0,0,0.7), 0 0 0 1px rgba(255,255,255,0.05)"
          }}
        >
